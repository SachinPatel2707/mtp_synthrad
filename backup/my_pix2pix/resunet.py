...
class resunet(nn.Module):
    def __init__(self):
        ...
        """ Bridge """
        self.r5 = residual_block(512, 1024, stride=2)

        """ Decoder """
        self.d0 = decoder_block(1024, 512)
...
if __name__ == "__main__":
    inputs = torch.randn((4, 3, 160, 160))
    model = resunet()
    y = model(inputs)
    print(y.shape)
    test = torch.randn((3,160,160)).cuda()
    print(torchsummary.summary(model, test))
